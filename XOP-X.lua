	...
	game:GetService("UserInputService").InputBegan:Connect(function(input)
		if input.KeyCode == Enum.KeyCode.RightControl or input.KeyCode == Enum.KeyCode.P  then
			if library.toggledui == false then
				...
				tween:Create(Main,TweenInfo.new(0.3,Enum.EasingStyle.Back,Enum.EasingDirection.In),{Size = UDim2.new(0, 0, 0, 318)}):Play()
				tween:Create(MainStroke,TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.InOut),{Transparency = 1}):Play()
			else
				library.toggledui = false
				tween:Create(Main,TweenInfo.new(0.3,Enum.EasingStyle.Back),{Size = UDim2.new(0, 525, 0, 318)}):Play()
				tween:Create(MainStroke,TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.InOut),{Transparency = 0}):Play()
			end
		end
	end)
...
--------------------------------------------------------------------------
local Window = SciWareLib.CreateLib("XOP X HUB", "Dis")
local Tab = Window:NewTab("Autofarm")
local Tab2 = Window:NewTab("stat")
local Tab3 = Window:NewTab("buy")
local Tab4 = Window:NewTab("Teleport")
local Tab5 = Window:NewTab("Team")
local Tab6 = Window:NewTab("Setting")

local Section = Tab:NewSection("Section Name")
local Text = Section:NewLabel("Label")
...
Section:NewToggle("Autohaki", function(state)
function bringmon()
...
local Section = Tab2:NewSection("STAT")
local Text = Section:NewLabel("stat")

Section:NewToggle("Melee", function(state)
    while wait(.1) do
    local args = {
							[1] = "AddPoint",
							[2] = "Melee",
...
Section:NewToggle("Defense", function(state)
    while wait(.1) do
    local args = {
							[1] = "AddPoint",
							[2] = "Defense",
...
Section:NewToggle("Sword", function(state)
    while wait(.1) do
    local args = {
							[1] = "AddPoint",
							[2] = "Defense",
...
Section:NewToggle("Gun", function(state)
    while wait(.1) do
    local args = {
							[1] = "AddPoint",
							[2] = "Gun",
...
Section:NewToggle("Blox Fruit", function(state)
    while wait(.1) do
    local args = {
							[1] = "AddPoint",
							[2] = "Demon Fruit",
...
local Section = Tab3:NewSection("state")
local Text = Section:NewLabel("BUY")

Section:NewToggle("Superhuman", function(state)
    _G.Superhuman = state
local args = {
    [1] = "BuySuperhuman",
    [2] = true
...
Section:NewToggle("BuyElectricClaw", function(state)
    _G.BuyElectricClaw = state
local args = {
    [1] = "BuyElectricClaw",
    [2] = true
}
...
Section:NewToggle("SharkmanKarate", function(state)
local args = {
    [1] = "BuySharkmanKarate",
    [2] = true
}
...
Section:NewToggle("refunstat", function(state)
local args = {
    [1] = "BlackbeardReward",
    [2] = "Refund",
    [3] = "1"
...
local Section = Tab5:NewSection("Team")
local Text = Section:NewLabel("Marine")

Section:NewToggle("Marine", function(state)
    local args = {
    [1] = "SetTeam",
    [2] = "Marines"
}
...
local Text = Section:NewLabel("Pirates")

Section:NewToggle("Pirates", function(state)
    local args = {
    [1] = "SetTeam",
    [2] = "Pirates"
}
...
local Section = Tab4:NewSection("Teleport")
local Text = Section:NewLabel("World")

Section:NewToggle("World1", function(state)
    
end)

Section:NewToggle("World2", function(state)
    local args = {
...
Section:NewToggle("World3", function(state)
    local args = {
    [1] = "ZQuestProgress",
    [2] = "Zou"
}
...
local Section = Tab6:NewSection("Setting")
local Text = Section:NewLabel("Color")

Section:NewColorPicker("Color Text", Color3.fromRGB(0,0,0), function(color)
	print(color)
end)

Section:NewToggle("Anti AFK", _G.AntiAFK, function(state)
...
Section:NewToggle("rejoin", function(state)
    local ts = game:GetService("TeleportService")
    local p = game:GetService("Players").LocalPlayer
    ts:Teleport(game.PlaceId, p)
end)

Section:NewToggle("serverhop", function(state)
